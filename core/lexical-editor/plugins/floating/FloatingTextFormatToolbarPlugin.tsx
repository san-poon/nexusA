...
import { getDOMRangeRect, getSelectedNode, setFloatingElemPosition } from "@/core/lexical-editor/utils";
        ...
        >
            {editor.isEditable() && (
                <>
                    ...
                    >
                        <BoldIcon className="flex  group-disabled:opacity-25 bg-contain size-5 mt-[2px] align-[-0.25em] " />
                    </Button>
                    <Button
                        type="button"
                        onClick={() => {
