...
import { PiIcon, SigmaIcon } from "lucide-react";
...
export function LoadingCircle({ className }: IconProps) {
    return (
        <svg
            aria-hidden="true"
...
export function Magic({ className }: IconProps) {
    return (
        <svg
            width="469"
            height="469"
...
export function TriangleAlertIcon({ className }: IconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn("w-6 h-6", className)}>
...
export const TextBlockIcon = ({ className }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export const ImageBlockIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={cn("w-6 h-6", className)}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
    </svg>
);

export const QuizBlockIcon = ({ className }: IconProps) => (
...
export const PitfallIcon = ({ className }: IconProps) => (
...
export const ParanthesisIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className={cn("size-6", className)}>
        <path d="M8 21s-4-3-4-9 4-9 4-9" /><path d="M16 3s4 3 4 9-4 9-4 9" />
    </svg>
);

export const SigmaPiIcon = ({ className }: IconProps) => (
    <div className={cn('relative size-6', className)}>
        <SigmaIcon className="absolute top-1 left-1/2 transform -translate-x-1/2 size-4" />
        <ParanthesisIcon className="absolute top-0 left-1/2 transform -translate-x-1/2 size-6" />
    </div>
)